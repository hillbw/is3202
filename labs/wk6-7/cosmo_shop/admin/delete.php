...
if ((isset($_POST['productID'])) && ($_POST['productID'] != "")) {
  ...
  $Result1 = mysql_query($deleteSQL, $connCosmo) or die(mysql_error());
...
<div id="container">
  <div id="header"><p><img src="../images/cosmo_logo.gif" alt="CosmoFarmer 2.0" width="476" height="90"/>    </p>
...
<div class="natEx">
  ...
  <div id="mainContent">
    <h1>Delete Record   </h1>
    <p><strong>Record to delete: </strong><?php echo $row_rsProduct['productName']; ?></p>
